...
const firstApiFunc = async () => {
    ...
    meal.innerHTML = `
    <li class="recipe border w-80 h-64 rounded-xl overflow-hidden relative">
    <img class="object-cover" src="${mealImg}" alt="${mealName}">
    <div class="flex justify-between items-center absolute bottom-0 left-0 right-0 py-1.5 px-4 bg-white">
